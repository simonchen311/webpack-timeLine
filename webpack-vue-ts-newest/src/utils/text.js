...
export const getCellTextInfo = (cell, ctx, option) => {
  ...
  let space_height = option.space_height; // 宽高方向 间隙
  ...
  if (tr === "3") {
    ...
    let textH_all_Column = {};
    let textH_all_ColumnHeight = [];
    if (isInline) {
...
const drawLineInfo = (wordGroup, cancelLine, underLine, option) => {
...
const isSupportBoundingBox = (ctx) => {
...
const checkWordByteLength = (value) => {
